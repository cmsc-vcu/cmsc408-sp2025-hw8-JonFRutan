...
Dr. Leonard recommends we use run_sql_and_return_dataframe when testing the python code by running the cell.  
...
run_sql_and_return_html(cnx,"""
select `Income Group` from wdi_country group by `Income Group`
""")
